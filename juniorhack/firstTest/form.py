...
race_choices = [('asian','Asian'), ('white', 'White'), ('black', 'Black'), ('indian', 'Latino'),
...
topic_choices = [('politics', 'Politics'), ('environment', 'Environment'), ('religion', 'Religion')]
...
class PersonForm (forms.Form):
	...
	your_sexuality = forms.ChoiceField(label='Sexuality', widget=forms.RadioSelect, choices=sexuality_choices)# widget)
